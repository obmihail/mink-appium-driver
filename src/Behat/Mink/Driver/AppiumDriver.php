 ...
 */
class AppiumDriver extends CoreDriver
{
     ...
     */
    public function __construct($browserName = 'chrome', $desiredCapabilities = null, $wdHost = 'http://localhost:4444/wd/hub')
    {
...
JS;
    ...
    public function getElement( $strategy , $selector )
    {
        return $this->wdSession->element( $strategy , $selector );
    }

    public function getElements( $strategy , $selector )
    {
        return $this->wdSession->elements( $strategy , $selector );
    }

    public function shakeDevice()
    {
        $this->wdSession->appium()->device()->shake();
        return $this;
    }

    public function lockDevice( $Seconds = 5 )
    {
        $this->wdSession->appium()->device()->lock( array('seconds'=>$Seconds) );
        return $this;
    }

    public function deviceIsLocked()
    {
        return $this->wdSession->appium()->device()->is_locked();
    }

    public function devicePressKeycode( $KeyCode = null, $MetaState = null )
    {
        $this->wdSession->appium()->device()->press_keycode( array( 'keycode'=>$KeyCode, 'metastate'=>$MetaState ) ); 
        return $this;
    }


    public function deviceLongPressKeycode( $KeyCode = null, $MetaState = null )
    {
        $this->wdSession->appium()->device()->long_press_keycode( array( 'keycode'=>$KeyCode, 'metastate'=>$MetaState ) );
        return $this;
    }


    public function deviceKeyEvent( $KeyCode = null, $MetaState = null )
    {
        $this->wdSession->appium()->device()->keyevent( array( 'keycode'=>$KeyCode, 'metastate'=>$MetaState ) );
        return $this;
    }


    public function deviceRotate( $duration = 1, $element = null, $x = 0.5, $y = 0.5, $radius = 0.5, $touchCount = 2, $rotation = 3.14159265359 )
    {
        $aParams = array(
            'duration',
            'x' => $x,
            ...
            'duration' => $duration,
            'element' => ( $element instanceof Container ) ? $element->getID : null,
            );
        $this->wdSession->appium()->device()->rotate( $aParams );
        return $this;
    }
     ...
     * @return string
     */
    public function getCurrenDeviceActivity()
    {
        return $this->wdSession->appium()->device()->current_activity();
    }


    public function installAppToDevice( $AppPath )
    {
        $this->wdSession->appium()->device()->install_app();
        return $this;
    }

    public function removeAppFromDevice( $appId )
    {
        $this->wdSession->appium()->device()->remove_app();
        return $this;
    }
    ...
    {
        return $this->wdSession->appium()->device()->app_installed( array( 'bundleId' => $appId ) );
    }


    public function hideKeyboard( $keyName = null, $key = null, $strategy = null )
    {
        $this->wdSession->appium()->device()->hide_keyboard();
        return $this;
    }


    public function pushFileOnDevice( $data , $path )
    {
        $this->wdSession->appium()->device()->push_file();
        return $this;
    }


    public function pullFileFromDevice( $pathOnDevice )
    {
        return $this->wdSession->appium()->device()->pull_file();
    }


    public function pullFolderFromDevice( $pathOnDevice )
    {
        return $this->wdSession->appium()->device()->pull_folder();
    }


    public function toggleAirplaneMode( )
    {
        $this->wdSession->appium()->device()->toggle_airplane_mode();
        return $this;
    }
    ...
    {
        $this->wdSession->appium()->device()->toggle_data();
        return $this;
    }
    ...
    {
        $this->wdSession->appium()->device()->toggle_wifi();
        return $this;
    }
    ...
    {
        $this->wdSession->appium()->device()->toggle_location_services();
        return $this;
    }
    ...
    {
        $this->wdSession->appium()->device()->open_notifications();
        return $this;
    }
    ...
    {
        $this->wdSession->appium()->application()->launch();
        return $this;
    }
    ...
    {
        $this->wdSession->appium()->application()->close();
        return $this;
    }
    ...
    {
        $this->wdSession->appium()->application()->reset();
        return $this;
    }
    ...
    {
        $this->wdSession->appium()->application()->background();
        return $this;
    }

    public function endTestCoverage( $intent , $path )
    {
        $this->wdSession->appium()->application()->end_test_coverage();
        return $this;
    }

    public function getStrings( $language = null )
    {
        return $this->wdSession->appium()->application()->strings( $language );
    }

    public function setAppiumElementValue( $strategy, $locator, $value )
    {
        $this->wdSession->getappium()->elementValue();
        return $this;
    }

    public function replaceAppiumElementValue( $strategy, $locator, $value )
    {
        $this->wdSession->getappium()->replaceElementValue();
        return $this;
    }
